...
const EditorCanvas = (props: Props) => {
  ...
  const nodeTypes = useMemo(
    () => ({
      ...
      "Get a chat": EditorCanvasCardSingle,
      "Get all administrators in a chat": EditorCanvasCardSingle,
      "Get a member in a chat": EditorCanvasCardSingle,
      "Leave a chat": EditorCanvasCardSingle,
      "Set description on a chat": EditorCanvasCardSingle,
      "Set a title on a chat": EditorCanvasCardSingle,
      "Answer query a callback": EditorCanvasCardSingle,
      "Answer an inline query callback": EditorCanvasCardSingle,
      "Get a file": EditorCanvasCardSingle,
      "Delete a chat message": EditorCanvasCardSingle,
      "Edit a test message": EditorCanvasCardSingle,
      "Pin a chat message": EditorCanvasCardSingle,
      "Send a text message": EditorCanvasCardSingle,
      "Send a media group message": EditorCanvasCardSingle,
      "Send a photo message": EditorCanvasCardSingle,
      "Send an animated file": EditorCanvasCardSingle,
      "Send an audio file": EditorCanvasCardSingle,
      "Send a chat action": EditorCanvasCardSingle,
      "Send a sticker": EditorCanvasCardSingle,
      "Send a video": EditorCanvasCardSingle,
      "Unpin a chat message": EditorCanvasCardSingle,
      "On message": EditorCanvasCardSingle,
      ...
      "Get the status of an issue": EditorCanvasCardSingle,
      "Get an issue changelog": EditorCanvasCardSingle,
      "Create an email notifications for an issue": EditorCanvasCardSingle,
      "Add an attachment to an issue": EditorCanvasCardSingle,
      "Get an attachment from an issue": EditorCanvasCardSingle,
      "Get many issue attachments": EditorCanvasCardSingle,
      "Remove an attachment from an issue": EditorCanvasCardSingle,
