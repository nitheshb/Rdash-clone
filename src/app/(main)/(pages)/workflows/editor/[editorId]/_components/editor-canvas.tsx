  ...
  const onDrop = useCallback(
    (event: any) => {
      ...
      const title = Object.keys(EditorCanvasDefaultCardTypes).find(
        (key) => EditorCanvasDefaultCardTypes[key as keyof typeof EditorCanvasDefaultCardTypes].value === type
      );
      const cardType = EditorCanvasDefaultCardTypes[title as keyof typeof EditorCanvasDefaultCardTypes];
